...
in
{
  standard = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      (sources."builtins-5.0.1" // { dependencies = [ sources."semver-7.3.8" ]; })
      ...
      (sources."eslint-plugin-n-15.6.1" // { dependencies = [ sources."semver-7.3.8" ]; })
      ...
      sources."levn-0.4.1"
      (sources."load-json-file-5.3.0" // { dependencies = [ sources."type-fest-0.3.1" ]; })
