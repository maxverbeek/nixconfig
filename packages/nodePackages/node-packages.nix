...
let
  sources = {
    ...
    "svelte-3.46.5" = {
      ...
      version = "3.46.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/svelte/-/svelte-3.46.5.tgz";
        sha512 = "T4txpIgYEGTkpFY2KQoqvtDmapu/suHMx0GN2zAImdJ7liEdG29P0XpjcNHnOEU1a4lLJn1WXxreobBSIGdcbQ==";
      };
    };
