    ...
    in
    {
      options.my.nordlynx = {
        ...
        servers = lib.mkOption {
          ...
          default = {
            "NL Amsterdam" = {
              endpoint = "186.247.163.6:51820";
              publicKey = nl;
            }; # nl1252
            "NL Amsterdam 2" = {
              endpoint = "186.247.163.10:51820";
              publicKey = nl;
            }; # nl1254
            "DE Hamburg" = {
              endpoint = "187.40.53.116:51820";
              publicKey = "qJb7+jCxGN8MAcSTKcDvDE81XobRBv1mu+phcB3zOGw=";
            }; # de1543
            "BE Brussels" = {
              endpoint = "187.13.21.76:51820";
              publicKey = "VSa6XYcD279ahd3IuEiUH6VpXn0+h+kWrD4OcN1ExUs=";
            }; # be316
            "UK London" = {
              endpoint = "217.146.92.158:51820";
              publicKey = "K53l2wOIHU3262sX5N/5kAvCvt4r55lNui30EbvaDlE=";
            }; # uk2265
            "US New York" = {
              endpoint = "138.199.52.107:51820";
              publicKey = "0/x2PdBGfcIGr0ayFPFFjxcEEyhrlBRjR4kMcfwXJTU=";
            }; # us8368
            "SE Stockholm" = {
              endpoint = "187.15.110.3:51820";
              publicKey = "EdKGlWFPgosHt/9vGBfcIv39umAsMrvbOxw9c3CZMw4=";
            }; # se650
            "CH Zurich" = {
              endpoint = "187.15.170.129:51820";
          ...
          (lib.mkIf (cfg.mode == "networkmanager") {
            ...
            networking.networkmanager.ensureProfiles = {
              profiles = lib.mapAttrs' (
                name: s:
                lib.nameValuePair "nordlynx-${lib.toLower (lib.replaceStrings [ " " ] [ "-" ] name)}" {
                  connection = {
                    id = "NordLynx ${name}";
                    type = "wireguard";
